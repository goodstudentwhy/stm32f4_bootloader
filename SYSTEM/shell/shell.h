...
#define     SHELL_AGENCY_FUNC(_func, ...) \
	...
	#define USER_SHELL_EXPORT_CMD(_attr,_name, _func, _desc) \
            const char shellCmd##_name[] = #_name; \
            const char shellDesc##_name[] = #_desc; \
            const ShellCommand \
            shellCommand##_name SECTION("shellCommand") =  \
            { \
                .attr.value = SHELL_CMD_PERMISSION(0)|SHELL_CMD_TYPE(_attr)|SHELL_CMD_DISABLE_RETURN, \
                .data.cmd.name = shellCmd##_name, \
                .data.cmd.function = (int (*)())_func, \
                .data.cmd.desc = shellDesc##_name \
            }
	...
	#define USER_SHELL_CMD_AGENCY(_attr,_name, _func, _desc, ...) \
            SHELL_AGENCY_FUNC(_func, ##__VA_ARGS__) \
            SHELL_EXPORT_CMD(SHELL_CMD_PERMISSION(0)|SHELL_CMD_TYPE(_attr)|SHELL_CMD_DISABLE_RETURN, \
							_name, SHELL_AGENCY_FUNC_NAME(_func), _desc)
	...
	#define USER_SHELL_EXPORT_VAR(_attr, _name, _value, _desc) \
            const char shellCmd##_name[] = #_name; \
            const char shellDesc##_name[] = #_desc; \
            const ShellCommand \
            shellVar##_name SECTION("shellCommand") =  \
...
//#define USER_SHELL_CMD_AGENCY(_attr,_name, _func, _desc, ...)  SHELL_EXPORT_CMD_AGENCY(_attr, _name, _func, _desc, ...)
